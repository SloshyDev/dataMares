...
export default function Footer() {
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-3 py-4 text-center items-center bg-zinc-100 dark:bg-zinc-800 transition-colors duration-300 border-t-2 border-gray-300 dark:border-gray-700 w-full'>
            ...
            <Link href="/" prefetch={true} aria-label="Ir a la página principal de dataMares" className="block lg:order-2 my-2 lg:my-0">
            ...
            <Link href="/partners" prefetch={true} aria-label="Ver nuestros partners y colaboradores" className="block order-1 lg:order-3 my-2 lg:my-0">
