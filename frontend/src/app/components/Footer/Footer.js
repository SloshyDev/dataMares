...
export default function Footer() {
  ...
  return (
    <div className="border-t-2 border-gray-300 bg-zinc-100 transition-colors duration-300 dark:border-gray-700 dark:bg-zinc-800">
      <div className="mx-auto grid w-full max-w-[2048px] grid-cols-1 items-center py-4 text-center lg:grid-cols-3">
        ...
        <Link
          href="/"
          prefetch={true}
          aria-label="Ir a la página principal de dataMares"
          className="my-2 block lg:order-2 lg:my-0"
        >
