                        ...
                        <li key={menu.label || index}>
                            {menu.href ? (
                                ...
                                <button
                                    ...
                                    className="w-full flex items-center justify-between px-4 py-2 text-gray-800 dark:text-gray-200 hover:bg-zinc-200 dark:hover:bg-zinc-800 rounded-lg transition-colors"
                                >
